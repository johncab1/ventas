...
class ArticulosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create articulo" do
    assert_difference('Articulo.count') do
      post articulos_url, params: { articulo: { nombre: @articulo.nombre, precio: @articulo.precio, unidad: @articulo.unidad } }
    end
  ...
  test "should update articulo" do
    patch articulo_url(@articulo), params: { articulo: { nombre: @articulo.nombre, precio: @articulo.precio, unidad: @articulo.unidad } }
