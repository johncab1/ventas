...
class EntradasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create entrada" do
    assert_difference('Entrada.count') do
      post entradas_url, params: { entrada: { cantidad: @entrada.cantidad, nombre: @entrada.nombre, precio: @entrada.precio, unidad: @entrada.unidad } }
    end
  ...
  test "should update entrada" do
    patch entrada_url(@entrada), params: { entrada: { cantidad: @entrada.cantidad, nombre: @entrada.nombre, precio: @entrada.precio, unidad: @entrada.unidad } }
